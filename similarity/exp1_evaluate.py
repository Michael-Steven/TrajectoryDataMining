...
num_query = 1000
save_output_dir = Path("./outputs_encoder/")
hidden_size = 128
batch_size = 16
bidirectional = 0
n_layers = 1
...
# label_path = "./experiment/porto/exp1/exp1-trj.label"
label_path = "./experiment/geolife/exp1/exp1-trj.label"
...
ranks_list = []
precision_list = []
save_output_path = "./outputs_encoder/encoder_0099_hiddensize_128_batchsize_128_bidirectional_0_nlayers_1_freeze_1_geolife_tcn.pkl"
stem = save_output_path.split("/")[2].split("_")
