...
test_model_dir = "./log/geolife_tcn/"
test_model_type = "LSTM"
save_output_format = "./outputs_encoder/{}_{}_hiddensize_{}_batchsize_{}_bidirectional_{}_nlayers_{}_freeze_{}_geolife_tcn.pkl"
max_len = 100
hidden_size = 128
batch_size = 128
bidirectional = 0
...
for test_model_path in Path(test_model_dir).iterdir():
    if not test_model_path.name.startswith("checkpoint_"):
        continue
    if test_model_path.name != "checkpoint_0099_hiddensize_{}_batchsize_{}_bidirectional_{}_nlayers_{}_freeze_{}.pth.tar".format(hidden_size,
