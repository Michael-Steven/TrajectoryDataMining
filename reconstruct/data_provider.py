...
class TrajDataloder:
    ...
    def get_slice(self, i):
        ...
        # print(reshaped_history_trajs)
        # print(reshaped_history_trajs.shape)
        # print(masked_current_trajs.shape)
        ...
        # print(reshaped_history_alias_inputs.shape)
        # print(reshaped_history_alias_inputs)
        # print(reshaped_history_items.shape)
        # print(reshaped_history_items)
        # exit(0)
